...
def decode_all_images(showfile, output):
...
def main():
    show = decode_all_images("build/show/show.shw", "dist/images/show")
    show2 = decode_all_images("build/show/show2.shw", "dist/images/show2")
    ...
    repack_show_without_menu("build/fs/show.shw", show[7:])
    repack_show_without_menu("build/fs/show2.shw", show2[5:])

    # Get composited splashscreen images as PIL images

    splash1 = Image.open("dist/images/show-00-c.png")
    splash2 = Image.open("dist/images/show-01-c.png")
    ...
    image_to_644x388(splash1).save("dist/images/splash1.png", optimize=1)
    image_to_644x388(splash2).save("dist/images/splash2.png", optimize=1)
    ...
    menu = Image.open("dist/images/show-02-c.png")
    menu_clear = Image.open("dist/images/show-03.png")
    ...
    cursor_only = image_to_644x388(Image.open("dist/images/show-03-c.png"))
    cursor_only.save("dist/images/menu-cursor.png", transparency=0, optimize=1)

    # Extract an icon image from the menu cursor

    icon = icon_border(cursor_only.crop((50, 12, 50 + 76, 12 + 68))).resize((512, 512))
    icon.save("dist/images/icon.png", transparency=4, optimize=1)
