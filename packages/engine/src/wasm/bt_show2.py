...
b = sbt86.DOSBinary("Show2EXE", "build/menu2.exe", basename="show2.exe")
...
# infinite loop. Exit the process instead.
b.patchAndHook(sbt86.Addr16(str="019E:0221"), "ret", "return rt.eng->exit(rt.io, 0);")
...
b.writeCodeToFile("build/bt_show2.cpp")
