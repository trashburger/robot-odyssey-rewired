...
b = sbt86.DOSBinary("GameEXE", "build/game.exe")
b.symbols.loadGhidraXML("../../notes/game.exe.xml")
...
b.patchAndHook("0E3B:2CBE", "ret", 'rt.io->error("World load failed");')
...
b.patchAndHook("0E3B:2C96", "ret", 'rt.eng->exec("show2.exe");' "return true;")

b.writeCodeToFile("build/bt_game.cpp")
