...
class OriginalFileCollector:
    hashes = {
        # Binaries will be converted to wasm
        ...
        # Font will be converted to a web font
        "cd000439bb2d137bd6b9ecfd86d432708f23aa3a": "font/font.fon",
        # Show files will be repacked before inclusion in the game filesystem
        "6a0f6f3b102491e6b6c6a42cc48abbcc17249a95": "show/show2.shw",
        "40adb729d3e86be25cde6796d87b3d0560e7e239": "show/show.shw",
        # Original files that will be directly included in the game filesystem
    ...
    def finish(self, dir):
        if self.remaining:
            ...
            sys.stderr.write(
                ...
                "in the %r directory.\n"
                "You can simply place a zip file in this directory,\n"
                "no need to extract it yourself.\n\n%s\n\n"
